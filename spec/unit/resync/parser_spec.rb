...
module Resync
  describe Parser do
    ...
    it 'parses example 2' do
      ...
      url1 = urls[1]
      expect(url1.loc).to eq(URI('http://example.com/res2'))
      expect(url1.lastmod).to eq(Time.utc(2013, 1, 2, 14))
      md1 = url1.md
    ...
    it 'parses example 4' do
      ...
      expect(url0.lastmod).to eq(Time.utc(2013, 1, 3, 9))
    end
    ...
    it 'parses example 5' do
      ...
      url0 = urls[0]
      expect(url0.loc).to eq(URI('http://example.com/res1'))
      expect(url0.lastmod).to eq(Time.utc(2013, 1, 3, 3))
      md0 = url0.md
      expect(md0.hash).to eq('md5:1584abdf8ebdc9802ac0c6a7402c03b6')
      ...
      url1 = urls[1]
      expect(url1.loc).to eq(URI('http://example.com/res2'))
      expect(url1.lastmod).to eq(Time.utc(2013, 1, 3, 4))
      md1 = url1.md
      expect(md1.hash).to eq('md5:1e0d5cb8ef6ba40c99b14c0237be735e')
